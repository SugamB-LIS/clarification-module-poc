...
- **If user input can be answered with 'metadata'**:  
   ...
   - The ouput should have explicit info instead of vague data, specially for clarification on Time Periods. Eg: "the last year" or "month prior to last" or "previous quarter" or "last 3 [timeperiod]" should always be replaced with exact information
